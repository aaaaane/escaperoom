...
@endif
        @endforeach
<a href="{{url('sala1')}}" ><input type="button" value="Sala anterior" class="btn btn-default"/></a><a href="{{url('sala3')}}" ><input type="button" value="Sala següent" class="btn btn-default"/></a>
            </div>
          </div>
        </div>
    ...
    <div class="col-md-6">
                ...
                <!--'route' => 'comment.store',-->
                 ...
                 {!! Form::open([ 'method' => 'post', 'novalidate']) !!}
                    ...
                    {!! Form::hidden('room_id', '2', ['class' => 'form-control' , 'required' => 'required']) !!}
