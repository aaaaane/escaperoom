...
@endif
        @endforeach
        <a href="{{url('sala2')}}" ><input type="button" value="Següent sala" class="btn btn-default"/></a>
            </div>
          </div>
        </div>
    ...
    <div class="col-md-6">
                ...
                <!--'route' => 'comment.store',-->
                 ...
                 {!! Form::open([ 'method' => 'post', 'novalidate']) !!}
                    ...
                    {!! Form::hidden('room_id', '1', ['class' => 'form-control' , 'required' => 'required']) !!}
